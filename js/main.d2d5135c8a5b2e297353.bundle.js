(self["webpackChunkloader_netology_js"] = self["webpackChunkloader_netology_js"] || []).push([[179],{
...
var cjs_js_src = __webpack_require__(518);
...
;// CONCATENATED MODULE: ./src/tools/helpers.js
var THOSE_NUMBERS = ['2', '3', '4'];
var parseList = function parseList(list) {
  return list.map(function (item) {
    var title = item.direction.title;
    var numberOfCourses = item.groups.reduce(function (prev, curr) {
      /* eslint-disable no-param-reassign */
      prev += curr.items.length;
      return prev;
    }, 0);
    var numberOfCoursesFormatted = numberOfCourses.toString();
    var lastNumber = numberOfCoursesFormatted[numberOfCoursesFormatted.length - 1];

    if (THOSE_NUMBERS.includes(lastNumber) && !(numberOfCourses % 100 < 19 && numberOfCourses % 100 > 10)) {
...
var createContainer = function createContainer(props) {
  var result = document.createElement(props.type);
  Object.keys(props).forEach(function (prop) {
    if (prop !== 'children') result[prop] = props[prop];else props[prop].forEach(function (elem) {
      return result.append(elem);
    });
  });
  return result;
};
var createDiv = function createDiv(quantity) {
  var result = [];
...
var DirectionHeader = function DirectionHeader(innerText) {
...
var DirectionSubheader = function DirectionSubheader(innerText) {
  return createContainer({
    type: 'h3',
    innerText: innerText,
...
var DirectionAvatar = function DirectionAvatar() {
  return createContainer({
    type: 'div',
...
var TextContainer = function TextContainer(textNodes) {
  return createContainer({
    type: 'div',
...
var ListHeader = function ListHeader(children) {
  return createContainer({
    type: 'h1',
...
var ListItem = function ListItem(item) {
  var header = DirectionHeader(item.title);
  var subheader = DirectionSubheader(item.numberOfCourses);
  var textContainer = TextContainer([header, subheader]);
  return createContainer({
    type: 'li',
    className: 'list-item',
...
;// CONCATENATED MODULE: ./src/tools/api.js



var fetchList = /*#__PURE__*/function () {
  var _ref = asyncToGenerator_default()( /*#__PURE__*/regenerator_default().mark(function _callee(url) {
    var response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            return _context.abrupt("return", parseList(response.data));
...
;// CONCATENATED MODULE: ./src/components/serveComponents.js

var EmphasisText = function EmphasisText(innerText) {
  return createContainer({
    type: 'span',
    innerText: innerText,
...
var renderList = function renderList(props) {
  ...
  app.append(loader);
  setTimeout(function () {
    return fetchList(url).then(function (result) {
      var emphasisText = EmphasisText('актуальные темы');
      var headerText = 'Изучайте ';
      var mainHeader = ListHeader([headerText, emphasisText]);
      parent.append(mainHeader);
      result.forEach(function (elem) {
        var listItem = ListItem(elem);
